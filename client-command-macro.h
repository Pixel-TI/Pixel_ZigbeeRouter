...
/** @brief Enter on calibration mode
 *
 * Cluster: Door Lock, Provides an interface into a generic way to secure a door.
 * Command: EnterCalibrateMode
 * @param userId uint16_t
 */
#define emberAfFillCommandDoorLockClusterEnterCalibrateMode(userId) \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                             | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                            ZCL_DOOR_LOCK_CLUSTER_ID, \
                            ZCL_ENTER_CALIBRATE_MODE_COMMAND_ID, \
                            "v", \
                            userId);
...
/** @brief Indicates enter calibrations success or failure
 *
 * Cluster: Door Lock, Provides an interface into a generic way to secure a door.
 * Command: calibrateModeResponse
 * @param status uint8_t
 */
#define emberAfFillCommandDoorLockClustercalibrateModeResponse(status) \
  emberAfFillExternalBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                             | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT), \
                            ZCL_DOOR_LOCK_CLUSTER_ID, \
                            ZCL_CALIBRATE_MODE_RESPONSE_COMMAND_ID, \
                            "u", \
                            status);
